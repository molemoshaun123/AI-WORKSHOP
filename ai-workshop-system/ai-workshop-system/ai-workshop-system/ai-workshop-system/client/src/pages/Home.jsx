  ...
  return (
    ...
    <div className="min-h-screen overflow-hidden bg-slate-950 text-white selection:bg-cyan-500/30">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute left-[-6rem] top-[-6rem] h-72 w-72 rounded-full bg-cyan-500/20 blur-[100px] animate-pulse"></div>
        <div className="absolute right-[-8rem] top-[8rem] h-96 w-96 rounded-full bg-blue-600/15 blur-[130px] animate-pulse"></div>
        <div className="absolute bottom-[-8rem] left-[20%] h-96 w-96 rounded-full bg-indigo-500/10 blur-[140px] animate-pulse"></div>
