  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white lg:flex">
      ...
      <div className="relative h-screen flex-1 overflow-auto">
        ...
        <div className="absolute right-0 top-0 -z-10 h-96 w-96 bg-blue-600/10 blur-[120px]"></div>
        <div className="absolute bottom-0 left-0 -z-10 h-96 w-96 bg-cyan-400/5 blur-[120px]"></div>
