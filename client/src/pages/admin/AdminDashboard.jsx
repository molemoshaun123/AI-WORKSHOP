            ...
            <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="h-48 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={metrics?.revenue_by_month || []}>
                      ...
                      <Tooltip contentStyle={{ backgroundColor: '#0f172a', borderColor: 'rgba(255,255,255,0.1)', borderRadius: '12px' }} formatter={(value) => [`R${value}`, 'Revenue']} />
              ...
              <div className="space-y-6">
                <div className="rounded-[2rem] border border-white/10 bg-slate-900/60 p-6 shadow-2xl backdrop-blur-xl">
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Revenue</p>
                  <p className="mt-2 text-3xl font-black text-white">R{Number(metrics?.total_revenue || 0).toFixed(2)}</p>
                  <p className="mt-1 text-xs font-semibold text-emerald-400">Paid Invoices</p>
                </div>
                <div className="rounded-[2rem] border border-white/10 bg-slate-900/60 p-6 shadow-2xl backdrop-blur-xl">
