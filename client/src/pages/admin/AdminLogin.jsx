  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <div className="absolute inset-0 -z-10">
        <div className="absolute right-[-7rem] top-[-6rem] h-80 w-80 rounded-full bg-emerald-500/20 blur-3xl"></div>
        <div className="absolute left-[-8rem] bottom-[-6rem] h-96 w-96 rounded-full bg-teal-500/15 blur-3xl"></div>
      </div>
